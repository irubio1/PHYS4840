...
"""
(simulations) irubio@RubilYio:~/PHYS4840_labs$ python trapz.py
Approximated Integral with N=1: 0.6839397205857212
(simulations) irubio@RubilYio:~/PHYS4840_labs$ python trapz.py
Approximated Integral with N=1: 0.6839397205857212
(simulations) irubio@RubilYio:~/PHYS4840_labs$ python trapz.py
Approximated Integral with N=3: 0.7399864752766818
(simulations) irubio@RubilYio:~/PHYS4840_labs$ python trapz.py
Approximated Integral with N=4: 0.7429840978003812
(simulations) irubio@RubilYio:~/PHYS4840_labs$ python trapz.py
Approximated Integral with N=5: 0.7443683397636671
